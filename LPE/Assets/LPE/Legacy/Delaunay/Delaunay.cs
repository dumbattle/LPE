...
namespace LPE.Legacy {
    ...
    public class Delaunay {
        ...
        public void AddConstraint(Vector2 a, Vector2 b, int ID=0) {
            AddPoint(a);
            AddPoint(b);
            ...
            newEdges.Clear();
            while (intersect.Count > 0 && safety.Next()) {
        ...
        public void RemovePoint(Vector2 p) {
            ...
            var safety = new LoopSafety(1000);
            while (poly.Count > 0 && safety.Next()) {
            ...
            while (orderedVerts.Count > 3 && safety.Next()) {
